...
% proportion of "hits" and store this in a variable called 'pHit' and the
% proportion of "false positives" and store this in 'pFP'. When you are
% finished, each variable should be of size, 18 rows by 1 column.
