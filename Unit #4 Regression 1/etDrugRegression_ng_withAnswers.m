...
%
% The 95% CI for the slope ([-0.0666,-0.0483]) does not include the null
% value of 0.
...
%
% mdl1.Coefficients.Estimate(1) = 34.1675

% QUESTION (Q4): What is its corresponding standard error?
%
% mdl1.Coefficients.SE(1) = 0.8672
...
% Trevor Hastie and Rob Tibshirani argue the LOOCV is not ideal because it
...
% 'regress' function for efficiency.
...
% than bootstrapping residuals." Bootstrapping residuals assumes that the
% error distribution (i.e. residuals) does not depend on x_i, and this is
% not always the case. It depends a lot on how good our assumption of
% linearity is and on the homoscedasticity of the data. See fig. 9.2 on p.
% 114 of E&T
