...
% running the loops multlple times. And we could make our variation in
...
probGuessing = sum(LL) ./ nSims;

% Or, to be super-MATLAB macho:
nSims = 10000; nTrials = 50; nCorrect = 31; pNull = 0.5;
...
% provides pdf's and cdf's for just about any statistical function you
% might imagine. Type:
