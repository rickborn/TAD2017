...
% module entitled "Bayes coin demo." You will answer a series of questions
% based on the guided programming below. The first time through, you will
% attempt to answer the questions on your own; the second time you will
% work with your team and submit one answer per team. Don't worry about
% your scores! (The class is pass/fail. This is just a way to have fun and
% track your progress.)
%
...
% in learning catalytics will be indicated in parentheses (e.g. Q1). If
% there is no 'Q#' accompanying a 'QUESTION' just type your answer into
% this script and discuss it with your team. Once you have supplied the
...
% QUESTION (Q6): State in words what we mean by a 'confidence interval':
