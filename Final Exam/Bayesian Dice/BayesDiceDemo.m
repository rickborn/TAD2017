...
% chosen than the 12-sided die (20/12 = 5/3) and the 6-sided die is 1.5
% times more likely to be picked than the 4-sided die (6/4 = 3/2 = 1.5).
%
% If you were to now see the same sequence of two rolls (5,10) from a
% non-randomly (i.e. biased by human shape preferences) chosen die, what
% are the new odds in favor of the 12-sided die being the chosen one?
